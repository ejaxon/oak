<Card id="images" locked {...props}>
  // card parameters accessible in URL, saved in state (?)
  <Params>
    <Param name="selctor" type="text" values={["images", "people"]} default="images"/>
  ...
  <Toolbar ref="header" layout="flow" class="top attached hiding">
    ...
    <Spacer spring/>
    <Component path="images/sortSelector" source="card.sort"/>
    <Component path="images/filterSelector" source="card.filter"/>
  </Toolbar>

  <Component path="images/ImageListViewer" preset="fullPageScroller"
